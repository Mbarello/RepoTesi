...
//    this.signal_id= signal;
  ...
  throws java.lang.Exception {
   ...
   // System.out.println("Eseguita l'analisi delle Stazionarieta");
    ...
    for (I= 0; I < output.trendInstances.size(); I++){
      if ((output.getTrendInstance(I).getInterval().getEnd() - output.getTrendInstance(I).getInterval().getStart()) == 0) {
              output.trendInstances.remove(I);
              I--;
      }
    }
    ...
    for (I= 1; I < output.trendInstances.size(); I++){
      if ((output.getTrendInstance(I-1).getTrendSymbol().getSymbol().compareTo("UNKNOWN") == 0) &&
              (output.getTrendInstance(I-1).getInterval().getEnd() == output.getTrendInstance(I).getInterval().getEnd()) &&
              (output.getTrendInstance(I-1).getInterval().getStart() == output.getTrendInstance(I).getInterval().getStart())) {
              output.trendInstances.remove(I-1);
              I--;
      }
      else if ((output.getTrendInstance(I).getTrendSymbol().getSymbol().compareTo("UNKNOWN") == 0) &&
              (output.getTrendInstance(I-1).getInterval().getEnd() == output.getTrendInstance(I).getInterval().getEnd()) &&
              (output.getTrendInstance(I-1).getInterval().getStart() == output.getTrendInstance(I).getInterval().getStart())) {
              output.trendInstances.remove(I);
              I--;
